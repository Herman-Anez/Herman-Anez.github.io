...
import TableOfContents from "@/modules/about/3-infrastructure/presentation/magic-pf-components/original/TableOfContents";
import styles from "@/modules/about/3-infrastructure/presentation/magic-pf-components/original/about.module.scss";
import React from "react";
import { RenderHTML } from "@/modules/site/3-infrastructure/presentation/components/render-html";
...
export function AboutView({ about, person, social, dict }: AboutViewProps) {
  const structure = [
    {
        ...
        {about.avatar.display && (
          ...
          >
            ...
            <Row gap="8" vertical="center">
              ...
              {person.location as unknown as string}
            </Row>
          ...
          >
            {about.calendar.display && (
              ...
              >
                ...
                <Row paddingX="8">{dict.ui.scheduleCall || "Schedule a call"}</Row>
                <IconButton
